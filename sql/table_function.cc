...
int Json_table_column::print(String *str)
{
  return str->append("x INT");
}
...
int Json_table_nested_path::print(String *str,
...
int Table_function_json_table::print(String *str,
                                     enum_query_type query_type)
{
  ...
  if (str->append(", '") ||
      ...
      str->append("' ") ||
      m_nested_path.print(str, jc_i, &jc) ||
      str->append(")"))
    DBUG_RETURN(TRUE);
